...
class LocalZipformerAsrClient @Inject constructor(
    ...
    private fun ensureRecognizer(): OfflineRecognizer {
        ...
        val zipformerCtc = OfflineZipformerCtcModelConfig(
    ...
    companion object {
        const val MODEL_ASSET_DIR = "zipformer_ctc"
    }
}
